...
$updateDescription	='<span style="color:orange">Install/Update all tables for Single Match</span>';
$excludeFile		='false';
...
function ImportTables()
{
	...
	$imports=file_get_contents(JPATH_ADMINISTRATOR.DS.'components'.DS.'com_joomleague'.DS.'sql'.DS.'match_single.sql');
...
<?php
	...
	JToolBarHelper::title(JText::_('Prediction Extension - Database update process'));
