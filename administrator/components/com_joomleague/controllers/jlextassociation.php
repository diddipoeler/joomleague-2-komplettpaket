 ...
 * @since	0.1
 */
class JoomleagueControllerJlextassociation extends JoomleagueController
{
	
  protected $view_list = 'jlextassociations';
  ...
  function __construct()
	...
	function cancel()
	{
		...
		$model=$this->getModel('jlextassociation');
		$model->checkin();
		$this->setRedirect('index.php?option=com_joomleague&view=jlextassociations&task=jlextassociation.display');
	}
