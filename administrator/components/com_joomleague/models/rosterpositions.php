 ...
 * @since	0.1
 */
class JoomleagueModelrosterpositions extends JoomleagueModelList
{
	...
	function _buildQuery()
	{
		...
		$query='	SELECT	obj.*,
							u.name AS editor
					FROM #__joomleague_rosterposition AS obj
	...
	{
		$db =& JFactory::getDBO();
		$query='SELECT id, name FROM #__joomleague_rosterposition ORDER BY name ASC ';
		$db->setQuery($query);
