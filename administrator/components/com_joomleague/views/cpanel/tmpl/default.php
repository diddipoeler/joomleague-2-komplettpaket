...
<table width="100%" border="0">
	<tr>
		<td width="55%" valign="top">
			<div id="cpanel">
				<?php echo $this->addIcon('icon-48-clubs.png','index.php?option=com_joomleague&view=clubs', JText::_('COM_SPORTSMANAGEMENT_D_MENU_CLUBS'));?>
				<?php echo $this->addIcon('icon-48-teams.png','index.php?option=com_joomleague&view=teams', JText::_('COM_SPORTSMANAGEMENT_D_MENU_TEAMS'));?>
				<?php echo $this->addIcon('icon-48-leagues.png','index.php?option=com_joomleague&view=leagues', JText::_('COM_SPORTSMANAGEMENT_D_MENU_LEAGUES'));?>
				<?php echo $this->addIcon('icon-48-seasons.png','index.php?option=com_joomleague&view=seasons', JText::_('COM_SPORTSMANAGEMENT_D_MENU_SEASONS'));?>
				<?php echo $this->addIcon('icon-48-playground.png','index.php?option=com_joomleague&view=playgrounds', JText::_('COM_SPORTSMANAGEMENT_D_MENU_VENUES'));?>
				<?php echo $this->addIcon('icon-48-positions.png','index.php?option=com_joomleague&view=positions', JText::_('COM_SPORTSMANAGEMENT_D_MENU_POSITIONS'));?>
				<?php echo $this->addIcon('icon-48-statistics.png','index.php?option=com_joomleague&view=statistics', JText::_('COM_SPORTSMANAGEMENT_D_MENU_STATISTICS'));?>
				<?php echo $this->addIcon('icon-48-sportstypes.png','index.php?option=com_joomleague&view=sportstypes', JText::_('COM_SPORTSMANAGEMENT_D_MENU_SPORTSTYPES'));?>
				<?php echo $this->addIcon('icon-48-events.png','index.php?option=com_joomleague&view=eventtypes', JText::_('COM_SPORTSMANAGEMENT_D_MENU_EVENTS'));?>
        <?php echo $this->addIcon('groups.gif','index.php?option=com_joomleague&view=persons', JText::_('COM_SPORTSMANAGEMENT_D_MENU_PERSONS'));?>
        <?php echo $this->addIcon('icon-48-agegroups.png','index.php?option=com_joomleague&view=agegroups', JText::_('COM_SPORTSMANAGEMENT_D_MENU_AGEGROUPS'));?>
        <?php echo $this->addIcon('world.png','index.php?option=com_joomleague&view=jlextcountries', JText::_('COM_SPORTSMANAGEMENT_D_MENU_COUNTRIES'));?>
        <?php echo $this->addIcon('association.jpg','index.php?option=com_joomleague&view=jlextassociations', JText::_('COM_SPORTSMANAGEMENT_D_MENU_ASSOCIATIONS'));?>
        <?php echo $this->addIcon('applications.gif','index.php?option=com_joomleague&view=extrafields', JText::_('COM_SPORTSMANAGEMENT_D_MENU_EXTRAFIELDS'));?>
