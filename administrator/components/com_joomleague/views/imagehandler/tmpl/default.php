...
<div class="imghead">
	...
	<?php echo JText::_( 'COM_JOOMLEAGUE_GLOBAL_SEARCH' ).' '; ?>
	...
	<button onclick="this.form.getElementById('search').value='';this.form.submit();"><?php echo JText::_( 'COM_JOOMLEAGUE_GLOBAL_RESET' ); ?></button>
