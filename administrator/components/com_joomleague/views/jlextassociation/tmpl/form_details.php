...
<fieldset class="adminform">
	...
	<table class="admintable">
		<tr>
			<td width="100" align="right" class="key"><label for="name"><?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ASSOCIATION_NAME'); ?></label></td>
			<td>
				<input class="text_area" type="text" name="name" id="title" size="32" maxlength="250" value="<?php echo $this->object->name; ?>" />
			</td>
		</tr>
		<tr>
			<td width="100" align="right" class="key"><label for="middle_name"><?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ASSOCIATION_MIDDLE_NAME'); ?></label></td>
			<td>
				<input class="text_area" type="text" name="middle_name" id="title" size="32" maxlength="25" value="<?php echo $this->object->middle_name; ?>" />
			</td>
		</tr>
		<tr>
			<td width="100" align="right" class="key"><label for="short_name"><?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ASSOCIATION_SHORT_NAME'); ?></label></td>
			<td>
				<input class="text_area" type="text" name="short_name" id="title" size="32" maxlength="15" value="<?php echo $this->object->short_name; ?>" />
			</td>
		</tr>		
		<tr>
			<td width="100" align="right" class="key"><label for="alias"><?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ASSOCIATION_ALIAS'); ?></label></td>
			<td>
		...
		<tr>
			<td valign="top" align="right" class="key"><label for="ordering"><?php echo JText::_('COM_JOOMLEAGUE_ADMIN_ASSOCIATION_ORDERING'); ?></label></td>
