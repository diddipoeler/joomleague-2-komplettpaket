...
<script language="javascript" type="text/javascript"><!--
	...
	function chkFormular()
	{
		...
		{
		  alert("<?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_ERROR'); ?>\n\n"+message);
		  return false;
		}
	}
	...
	function openSelectWindow(recordid,key,selector,box,datatype)
	{
		...
		query='index.php?option=com_joomleague&tmpl=component&view=jlextdfbnetplayerimport&controller=jlextdfbnetplayerimport'
				+ '&task=select'
				+ '&type=' + datatype
				+ '&id=' + key;
		//alert(query);
...
//--></script>
	<div id='editcell'>
		...
		<table class='adminlist'>
			<thead><tr><th><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_TABLE_TITLE_2'); ?></th></tr></thead>
			<tbody>
				<tr>
					<td style='text-align:center; '>
						<p style='text-align:center;'><b style='color:green; '><?php echo JText::sprintf('JL_ADMIN_DFBNET_IMPORT_UPLOAD_SUCCESS','<i>'.$this->uploadArray['name'].'</i>'); ?></b></p>
						<?php
...
// 									echo JText::_('As we can not guarantee a correct processing the import routine will STOP here!!!');
						...
						?><p><?php echo JText::sprintf('JL_ADMIN_DFBNET_IMPORT_HINT2',$this->revisionDate); ?></p>
						<p><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_CREATE_CLUBS_HINT'); ?></p>
					</td>
				</tr>
			</tbody>
		</table>
    ...
    <form name='adminForm' action='<?php echo $this->request_url; ?>' method='post' onsubmit='return chkFormular();' >
			...
			<input type='hidden' name='controller' value="jlextdfbnetplayerimport" />
			<input type='hidden' name='task' value="<?php echo $this->insert_task; ?>" />
			<?php echo JHTML::_('form.token')."\n"; ?>
			
			<div class="" <?php echo $this->style; ?> >
			<?php
			if (($xmlProjectImport) || ($xmlImportType=='events') || ($xmlImportType=='positions'))
			{
				?>
				<fieldset>
					<legend><strong><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_GENERAL_DATA_LEGEND'); ?></strong></legend>
					<table class='adminlist'>
						<?php
						if (($xmlImportType!='events') && ($xmlImportType!='positions'))
						{
							?>
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_PROJECT_NAME'); ?></td>
						...
						?>
						<tr>
							<td style='background-color:#DDDDDD'><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_SPORTSTYPE'); ?></td>
							<td style='background-color:#DDDDDD'>
								...
								if (count($this->sportstypes) > 0)
								{
									...
									<select name='sportstype' id='sportstype'>
										<option selected value="0"><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_SPORTSTYPE_SELECT'); ?></option>
										<?php
									...
									<input	type='checkbox' name='newSportsTypeCheck' value="1"
											...
											}" /><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_CREATE_NEW'); ?>
						...
						if (($xmlImportType!='events') && ($xmlImportType!='positions'))
						{
							?>
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_LEAGUE'); ?></td>
								<td style='background-color:#EEEEEE'>
									<?php
									...
									<select name='league' id='league'>
										<option selected value="0"><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_LEAGUE_SELECT'); ?></option>
										<?php
									...
									if (count($this->leagues) < 1)
									{
										...
										<input	checked='checked' type='checkbox' name='newLeagueCheck' value="1"
												onclick='this.checked=true;' /><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_CREATE_NEW'); ?>
							...
							<tr>
								<td style='background-color:#DDDDDD'><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_SEASON'); ?></td>
								<td style='background-color:#DDDDDD'>
									<?php
									...
									<select name='season' id='season'>
										<option selected value="0"><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_SEASON_SELECT'); ?></option>
										<?php
							...
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_ADMIN'); ?></td>
								<td style='background-color:#EEEEEE'>
							...
							<tr>
								<td style='background-color:#DDDDDD'><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_EDITOR'); ?></td>
								<td style='background-color:#DDDDDD'>
							...
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_TEMPLATES'); ?></td>
								<td style='background-color:#EEEEEE'>
									<select name='copyTemplate' id='copyTemplate'>
										<option value="0" selected><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_TEMPLATES_USEOWN'); ?></option>
										<?php
							...
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_PUBLISH'); ?></td>
								<td style='background-color:#EEEEEE'>
				...
				<p style='text-align:right;'><a href='#page_bottom'><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_BOTTOM'); ?></a></p>
				<?php
			}
			?>
			...
			if ((isset($clubs) && count($clubs) > 0) || (isset($teams) && count($teams) > 0))
			{
				...
				<fieldset>
					<legend><strong><?php
						...
						{
							echo JText::_('JL_ADMIN_DFBNET_IMPORT_CLUBS_TEAMS_LEGEND'); //JL_XML_IMPORT_TEAM_CLUB_LEGEND
						}
						elseif (!empty($clubs))
						{
							echo JText::_('JL_ADMIN_DFBNET_IMPORT_CLUBS_LEGEND');
						}
						else
						{
							echo JText::_('JL_ADMIN_DFBNET_IMPORT_TEAMS_LEGEND');
						}
						?></strong></legend>
					<table class='adminlist'>
						<thead>
							<tr>
								<th width='5%' nowrap='nowrap'><?php
									...
									echo JText::_('JL_ADMIN_DFBNET_IMPORT_ALL_NEW').'<br />';
									echo '<input type="checkbox" name="toggleTeamsClubs" value="" onclick="checkAllCustom('.$checkCount.')" />';
								?></th>
								<?php if (!empty($clubs)){ ?><th><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_TEAM_DATA'); ?></th><?php } ?>
								<?php if (!empty($teams)){ ?><th><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_CLUB_DATA'); ?></th><?php } ?>
							</tr>
						</thead>
						<tbody>
							<?php
...
// 													strtolower($teamClub->middle_name)==strtolower($row1->middle_name) &&
										...
										<td width='45%' style='text-align:left; vertical-align:top; background-color:<?php echo $color; ?>' id='tetd<?php echo $key; ?>'>
											...
											echo JText::sprintf('JL_ADMIN_DFBNET_IMPORT_USE_TEAM',$output);
											...
											if (count($this->teams) > 0)
											{
												...
												echo ")' ";
												echo "/>&nbsp;";
												echo JText::_('JL_ADMIN_DFBNET_IMPORT_ASSIGN_TEAM');
												echo '<br />';
											}
											else
											{
											...
											echo "/>&nbsp;";
											echo JText::_('JL_ADMIN_DFBNET_IMPORT_CREATE_TEAM');
											...
											<table cellspacing='0' cellpadding='0'>
												<tr>
													<td>
														<?php
														echo '<b>'.JText::_('JL_ADMIN_DFBNET_IMPORT_TEAMNAME').'</b>';
													...
													<td>
														<?php
														echo '<b>'.JText::_('JL_ADMIN_DFBNET_IMPORT_TEAMSHORT').'</b>';
                          ...
                          if (strtolower($clubname)==strtolower($row1->name) )
                            ...
                            //echo 'diddi 3 -> '.$clubname.":".$clubCountry."<br>";
										...
										<td width='45%' style='text-align:left; vertical-align:top; background-color:<?php echo $color; ?>' id='cltd<?php echo $key; ?>'>
											...
											echo JText::sprintf('JL_ADMIN_DFBNET_IMPORT_USE_CLUB',$output);
											...
											if (count($this->clubs) > 0)
											{
												...
												echo ")' ";
												echo "/>&nbsp;";
												echo JText::_('JL_ADMIN_DFBNET_IMPORT_ASSIGN_CLUB');
												echo '<br />';
											}
											else
											{
											...
											echo "/>&nbsp;";
											echo JText::_('JL_ADMIN_DFBNET_IMPORT_CREATE_CLUB');
											...
											<table cellspacing='0' cellpadding='0'>
												<tr>
													<td>
														<?php
														echo '<b>'.JText::_('JL_ADMIN_DFBNET_IMPORT_CLUBNAME').'</b>';
														?><br />
													...
													<td>
														<?php
														echo '<b>'.JText::_('JL_ADMIN_DFBNET_IMPORT_CLUBCOUNTRY').'</b>';
				...
				<p style='text-align:right;'><a href='#page_top'><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_TOP'); ?></a></p>
				<?php
			}
			// club ende
			?>
				...
				<fieldset>
					...
					<table class='adminlist'>
						<thead>
							<tr>
								<th width='5%' nowrap='nowrap'><?php
									echo JText::_('JL_ADMIN_DFBNET_IMPORT_ALL_NEW');
									echo '<br />';
			...
			if (isset($persons) && (is_array($persons) && count($persons) > 0))
			{
				?>
				<fieldset>
					<legend><strong><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_PERSON_LEGEND'); ?></strong></legend>
					<table class='adminlist'>
						<thead>
							<tr>
								<th width='5%' nowrap='nowrap'><?php
								...
								?></th>
								<th><?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_PERSON_DATA'); ?></th>
							</tr>
						</thead>
						<tbody>
							<?php
							...
							foreach ($persons AS $key=> $person)
							{
								...
								<tr>
									...
									<td width='45%' style='text-align:left; background-color:<?php echo $color; ?>' id='prtd<?php echo $key; ?>'>
										...
										echo JText::sprintf('JL_ADMIN_DFBNET_IMPORT_USE_PERSON',$output1,$output2,$output3,$output4);
										...
										if (count($this->persons) > 0)
										{
											...
											echo ")' ";
											echo "/>&nbsp;";
											echo JText::_('JL_ADMIN_DFBNET_IMPORT_ASSIGN_PERSON');
											echo '<br />';
										}
										else
										{
										...
										echo "/>&nbsp;";
										echo JText::_('JL_ADMIN_DFBNET_IMPORT_CREATE_PERSON');
										?>
										<br />
										<table cellspacing='0' cellpadding='0'>
											<tr>
												<td><?php echo '<b>'.JText::_('JL_ADMIN_DFBNET_IMPORT_LNAME').'</b>'; ?><br />
												...
												<td><?php echo '<b>'.JText::_('JL_ADMIN_DFBNET_IMPORT_FNAME').'</b>'; ?><br />
												...
												<td><?php echo '<b>'.JText::_('JL_ADMIN_DFBNET_IMPORT_NNAME').'</b>'; ?><br />
												...
												<td><?php echo '<b>'.JText::_('JL_ADMIN_DFBNET_IMPORT_PASSNUMBER').'</b>'; ?><br />
			...
			?>
			<p>
				<a name='page_bottom'></a><input type='submit' value="<?php echo JText::_('JL_ADMIN_DFBNET_IMPORT_START_BUTTON'); ?>" />
			</p>
		</form>
	</div>
	<?php
