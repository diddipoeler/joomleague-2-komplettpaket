...
// 		}
		...
		if (array_key_exists('impposition',$this->xml))
		{
			$imppositions =& $this->xml['impposition'];
		}
		if (array_key_exists('impparentposition',$this->xml))
		{
			$impparentpositions =& $this->xml['impparentposition'];
		}
...
// echo '<br>parentpositions<br><pre>';
// print_r($parentpositions);
// echo '</pre>';

// echo '<br>positions<br><pre>';
// print_r($positions);
// echo '</pre><br>';

// echo '<br>imppositions<br><pre>';
// print_r($imppositions);
// echo '</pre><br>';

// echo '<br>impparentpositions<br><pre>';
// print_r($impparentpositions);
// echo '</pre><br>';
...
// 		}
		...
		elseif (isset($imppositions))	// There shouldn't be any problems with import of positions-xml-export files
		{							// maybe the positions export routine should also export position_eventtype and events
			$xmlImportType='imppositions';
			$xmlImportTitle='Standart XML-Import of JoomLeague Positions';
		}
...
<script language="javascript" type="text/javascript"><!--
	...
	function chkFormular()
	{
		...
		{
		  alert("<?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_ERROR'); ?>\n\n"+message);
		  return false;
		}
	}
	...
	function openSelectWindow(recordid,key,selector,box,datatype)
	{
		...
		query='index.php?option=com_joomleague&tmpl=component&view=jlextindividualsportringen&controller=jlextindividualsportringen'
				+ '&task=select'
				+ '&type=' + datatype
				+ '&id=' + key;
		//alert(query);
...
//--></script>
	<div id='editcell'>
		...
		<table class='adminlist'>
			<thead><tr><th><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_TABLE_TITLE_2'); ?></th></tr></thead>
			<tbody>
				<tr>
					<td style='text-align:center; '>
						
						<?php
                        if ( $this->uploadArray['name'] )
                        {
                        ?>
<p style='text-align:center;'><b style='color:green; '><?php echo JText::sprintf('JL_ADMIN_EXTENSION_IMPORT_UPLOAD_SUCCESS','<i>'.$this->uploadArray['name'].'</i>'); ?></b></p>                        
                        <?php
                        }
                        if ( $this->serverfile )
                        {
                        ?>
<p style='text-align:center;'><b style='color:green; '><?php echo JText::sprintf('JL_ADMIN_EXTENSION_IMPORT_READ_SUCCESS','<i>'.$this->serverfile.'</i>'); ?></b></p>                        
                        <?php
                        }
...
// 									echo JText::_('As we can not guarantee a correct processing the import routine will STOP here!!!');
						...
						?><p><?php echo JText::sprintf('JL_ADMIN_EXTENSION_IMPORT_HINT2',$this->revisionDate); ?></p>
						<p><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_CREATE_CLUBS_HINT'); ?></p>
					</td>
				</tr>
			</tbody>
		</table>
		<form name='adminForm' action='<?php echo $this->request_url; ?>' method='post' onsubmit='return chkFormular();' >
			...
			if (($xmlProjectImport) || ($xmlImportType=='events') || ($xmlImportType=='positions'))
			{
				?>
				<fieldset>
					<legend><strong><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_GENERAL_DATA_LEGEND'); ?></strong></legend>
					<table class='adminlist'>
						<?php
						if (($xmlImportType!='events') && ($xmlImportType!='positions'))
						{
							?>
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_PROJECT_NAME'); ?></td>
						...
						?>
						<tr>
							<td style='background-color:#DDDDDD'><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_SPORTSTYPE'); ?></td>
							<td style='background-color:#DDDDDD'>
								...
								if (count($this->sportstypes) > 0)
								{
									...
									<select name='sportstype' id='sportstype'>
										<option selected value="0"><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_SPORTSTYPE_SELECT'); ?></option>
										<?php
									...
									<input	type='checkbox' name='newSportsTypeCheck' value="1"
											...
											}" /><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_CREATE_NEW'); ?>
						...
						if (($xmlImportType!='events') && ($xmlImportType!='positions'))
						{
							?>
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_LEAGUE'); ?></td>
								<td style='background-color:#EEEEEE'>
									<?php
									...
									<select name='league' id='league'>
										<option selected value="0"><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_LEAGUE_SELECT'); ?></option>
										<?php
									...
									if (count($this->leagues) < 1)
									{
										...
										<input	checked='checked' type='checkbox' name='newLeagueCheck' value="1"
												onclick='this.checked=true;' /><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_CREATE_NEW'); ?>
							...
							<tr>
								<td style='background-color:#DDDDDD'><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_SEASON'); ?></td>
								<td style='background-color:#DDDDDD'>
									<?php
									...
									<select name='season' id='season'>
										<option selected value="0"><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_SEASON_SELECT'); ?></option>
										<?php
							...
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_ADMIN'); ?></td>
								<td style='background-color:#EEEEEE'>
							...
							<tr>
								<td style='background-color:#DDDDDD'><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_EDITOR'); ?></td>
								<td style='background-color:#DDDDDD'>
							...
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_TEMPLATES'); ?></td>
								<td style='background-color:#EEEEEE'>
									<select name='copyTemplate' id='copyTemplate'>
										<option value="0" selected><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_TEMPLATES_USEOWN'); ?></option>
										<?php
							...
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_PUBLISH'); ?></td>
								<td style='background-color:#EEEEEE'>
				...
				<p style='text-align:right;'><a href='#page_bottom'><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_BOTTOM'); ?></a></p>
				<?php
			}
			?>
			<?php
			...
			if ((isset($clubs) && count($clubs) > 0) || (isset($teams) && count($teams) > 0))
			{
				...
				<fieldset>
					<legend><strong><?php
						...
						{
							echo JText::_('JL_ADMIN_EXTENSION_IMPORT_CLUBS_TEAMS_LEGEND'); //JL_XML_IMPORT_TEAM_CLUB_LEGEND
						}
						elseif (!empty($clubs))
						{
							echo JText::_('JL_ADMIN_EXTENSION_IMPORT_CLUBS_LEGEND');
						}
						else
						{
							echo JText::_('JL_ADMIN_EXTENSION_IMPORT_TEAMS_LEGEND');
						}
						?></strong></legend>
					<table class='adminlist'>
						<thead>
							<tr>
								<th width='5%' nowrap='nowrap'><?php
									...
									echo JText::_('JL_ADMIN_EXTENSION_IMPORT_ALL_NEW').'<br />';
									echo '<input type="checkbox" name="toggleTeamsClubs" value="" onclick="checkAllCustom('.$checkCount.')" />';
								?></th>
								<?php if (!empty($clubs)){ ?><th><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_TEAM_DATA'); ?></th><?php } ?>
								<?php if (!empty($teams)){ ?><th><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_CLUB_DATA'); ?></th><?php } ?>
							</tr>
						</thead>
						<tbody>
							<?php
...
// 													strtolower($teamClub->middle_name)==strtolower($row1->middle_name) &&
										...
										<td width='45%' style='text-align:left; vertical-align:top; background-color:<?php echo $color; ?>' id='tetd<?php echo $key; ?>'>
											...
											echo JText::sprintf('JL_ADMIN_EXTENSION_IMPORT_USE_TEAM',$output);
											...
											if (count($this->teams) > 0)
											{
												...
												echo ")' ";
												echo "/>&nbsp;";
												echo JText::_('JL_ADMIN_EXTENSION_IMPORT_ASSIGN_TEAM');
												echo '<br />';
											}
											else
											{
											...
											echo "/>&nbsp;";
											echo JText::_('JL_ADMIN_EXTENSION_IMPORT_CREATE_TEAM');
											...
											<table cellspacing='0' cellpadding='0'>
												<tr>
													<td>
														<?php
														echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_TEAMNAME').'</b>';
													...
													<td>
														<?php
														echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_TEAMSHORT').'</b>';
									...
									if (!empty($clubs))
									{
										...
										<td width='45%' style='text-align:left; vertical-align:top; background-color:<?php echo $color; ?>' id='cltd<?php echo $key; ?>'>
											...
											echo JText::sprintf('JL_ADMIN_EXTENSION_IMPORT_USE_CLUB',$output);
											...
											if (count($this->clubs) > 0)
											{
												...
												echo ")' ";
												echo "/>&nbsp;";
												echo JText::_('JL_ADMIN_EXTENSION_IMPORT_ASSIGN_CLUB');
												echo '<br />';
											}
											else
											{
											...
											echo "/>&nbsp;";
											echo JText::_('JL_ADMIN_EXTENSION_IMPORT_CREATE_CLUB');
											...
											<table cellspacing='0' cellpadding='0'>
												<tr>
													<td>
														<?php
														echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_CLUBNAME').'</b>';
														?><br />
													...
													<td>
														<?php
														echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_CLUBCOUNTRY').'</b>';
				...
				<p style='text-align:right;'><a href='#page_top'><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_TOP'); ?></a></p>
				<?php
			}
			// club ende
			?>
				...
				<fieldset>
					...
					<table class='adminlist'>
						<thead>
							<tr>
								<th width='5%' nowrap='nowrap'><?php
									echo JText::_('JL_ADMIN_EXTENSION_IMPORT_ALL_NEW');
									echo '<br />';
                      ...
                      strtolower($playground->alias) == strtolower($row1->alias) )
											{
												$color='lightgreen';
									...
									<td width='45%' style='text-align:left; background-color:<?php echo $color; ?>' id='pltd<?php echo $key; ?>'>
										...
										<table cellspacing='0' cellpadding='0'>
											<tr>
												...
												<td>
													<?php echo '<b>'.JText::_('Playground Alias').'</b>'; ?><br />
													<input type='text' name='playgroundAlias_<?php echo $key; ?>' size='45' maxlength='45' value="<?php echo stripslashes(htmlspecialchars($playground->alias)); ?>" <?php echo $disabled; ?> />
												</td>
											</tr>
										</table>
									</td>
			...
			?>
			<?php
			// parentpositions anfang
      if (isset($parentpositions) && (is_array($parentpositions) && count($parentpositions) > 0))
      //if (isset($impparentpositions) && (is_array($impparentpositions) && count($impparentpositions) > 0))
			{
				?>
				<fieldset>
      ...
      //if (isset($imppositions) && (is_array($imppositions) && count($imppositions) > 0))
			{
			...
			if (isset($persons) && (is_array($persons) && count($persons) > 0))
			{
				?>
				<fieldset>
					<legend><strong><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_PERSON_LEGEND'); ?></strong></legend>
					<table class='adminlist'>
						<thead>
							<tr>
								<th width='5%' nowrap='nowrap'><?php
								...
								?></th>
								<th><?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_PERSON_DATA'); ?></th>
							</tr>
						</thead>
						<tbody>
							<?php
                        ...
                        && ( $person->alias == $row1->alias )
                        && ( $person->knvbnr == $row1->knvbnr )
                                                ||
                                                ( strtolower($person->lastname) == strtolower($row1->lastname) 
                                                &&  $person->info == $row1->info
                                                &&  $person->alias == $row1->alias
                                                &&  $person->knvbnr == $row1->knvbnr )
												)
                                                )
									...
									<td width='45%' style='text-align:left; background-color:<?php echo $color; ?>' id='prtd<?php echo $key; ?>'>
										...
										echo JText::sprintf('JL_ADMIN_EXTENSION_IMPORT_USE_PERSON',$output1,$output2,$output3,$output4);
										...
										if (count($this->persons) > 0)
										{
											...
											echo ")' ";
											echo "/>&nbsp;";
											echo JText::_('JL_ADMIN_EXTENSION_IMPORT_ASSIGN_PERSON');
											echo '<br />';
										}
										else
										{
										...
										echo "/>&nbsp;";
										echo JText::_('JL_ADMIN_EXTENSION_IMPORT_CREATE_PERSON');
										?>
										<br />
										<table cellspacing='0' cellpadding='0'>
											<tr>
												<td><?php echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_LNAME').'</b>'; ?><br />
												...
												<td><?php echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_FNAME').'</b>'; ?><br />
												...
												<td><?php echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_NNAME').'</b>'; ?><br />
												...
												<td><?php echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_BIRTHDAY').'</b>'; ?><br />
											...
											<tr>
											  <td><?php echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_INFO').'</b>'; ?><br />
													<input type='text' name='personINFO_<?php echo $key; ?>' size='30' maxlength='45' value="<?php echo stripslashes(htmlspecialchars($person->info)); ?>" <?php echo $disabled; ?> />
												</td>
												<td><?php echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_PASSNUMBER').'</b>'; ?><br />
													<input type='text' name='personKNVBNR_<?php echo $key; ?>' maxlength='10' size='11' value="<?php echo $person->knvbnr; ?>" <?php echo $disabled; ?> />
												</td>
												<td><?php echo '<b>'.JText::_('JL_ADMIN_EXTENSION_IMPORT_ALIAS').'</b>'; ?><br />
													<input type='text' name='personAlias_<?php echo $key; ?>' maxlength='40' size='40' value="<?php echo $person->alias; ?>" <?php echo $disabled; ?> />
												</td>
											</tr>
										</table>
									</td>
			...
			?>
			<p>
				<a name='page_bottom'></a><input type='submit' value="<?php echo JText::_('JL_ADMIN_EXTENSION_IMPORT_START_BUTTON'); ?>" />
			</p>
		</form>
	</div>
	<?php
