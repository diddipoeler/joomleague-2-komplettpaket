	...
	<div id="editcell">
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th class="title" nowrap="nowrap" style="vertical-align: top; ">
						<?php
						echo JHTML::_('grid.sort','JL_ADMIN_RINGERPOSITION_NAME','obj.name',$this->lists['order_Dir'],$this->lists['order']);
						?>
					</th>
					<th class="title" nowrap="nowrap" style="vertical-align: top; ">
						<?php
						echo JHTML::_('grid.sort','JL_ADMIN_RINGERPOSITION_SHORT_NAME','obj.name',$this->lists['order_Dir'],$this->lists['order']);
						?>
					</th>					
					<th width="10%" class="title" style="vertical-align: top; ">
						<?php
						echo JHTML::_('grid.sort','JL_ADMIN_RINGERPOSITION_COUNTRY','obj.country',$this->lists['order_Dir'],$this->lists['order']);
						?>
					</th>
			...
			<tbody>
				...
				{
					$row =& $this->items[$i];
					$link=JRoute::_('index.php?option=com_joomleague&controller=jlextringerpositions&task=edit&cid[]='.$row->id);
					...
					<tr class="<?php echo "row$k"; ?>">
						...
						<td class="order">
							...
							<span>
								<?php echo $this->pagination->orderDownIcon($i,$n,$i < $n,'orderdown','JL_GLOBAL_ORDER_DOWN',$ordering); ?>
