 ...
 * @since	0.1
 */
class JoomleagueViewjlextuserextrafield extends JLGView
{
	...
	function _displayForm($tpl)
	{
		...
		{
			$msg=JText::sprintf('DESCBEINGEDITTED',JText::_('COM_JOOMLEAGUE_ADMIN_EXTRA_FIELD'),$season->name);
	...
	*/
	...
	{	
		...
		JLToolBarHelper::save('jlextuserextrafield.save');

		if (!$edit)
		{
			JToolBarHelper::title(JText::_('COM_JOOMLEAGUE_ADMIN_EXTRA_FIELD_ADD_NEW'),'jlextuserextrafields');
			JToolBarHelper::divider();
			JLToolBarHelper::cancel('jlextuserextrafield.cancel');
		}
		else
		{
