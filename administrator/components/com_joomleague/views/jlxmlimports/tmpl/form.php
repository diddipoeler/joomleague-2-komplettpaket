				...
				<fieldset>
					...
					<table class='adminlist'>
						...
						if (($xmlImportType!='events') && ($xmlImportType!='positions'))
						{
							...
							<tr>
								<td style='background-color:#EEEEEE'><?php echo JText::_('COM_JOOMLEAGUE_ADMIN_XML_IMPORT_ADMIN'); ?></td>
								<td style='background-color:#EEEEEE'>
							...
							<tr>
								<td style='background-color:#DDDDDD'><?php echo JText::_('COM_JOOMLEAGUE_ADMIN_XML_IMPORT_EDITOR'); ?></td>
								<td style='background-color:#DDDDDD'>
							...
							<tr>
								<td style='background-color:#DDDDDD'><?php echo JText::_('COM_JOOMLEAGUE_PROJECT_TIMEZONE'); ?></td>
								<td style='background-color:#DDDDDD'>
						...
						<thead>
							<tr>
								<th width='5%' nowrap='nowrap'><?php
									...
									echo JText::_('COM_JOOMLEAGUE_ADMIN_XML_IMPORT_ALL_NEW').'<br />';
                    ...
                    $matchingTeam_INFO = $team->info;
							...
							<tr>
								...
								<td style='line-height:200%; text-align:left; vertical-align:middle; background-color:<?php echo $color; ?>' id='tetd<?php echo $key; ?>'>
									...
									?>
									>
										<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_XML_IMPORT_EXISTING_CLUB_AND_TEAM'); ?>
									</input><br>
									<!--
									...
									?>
									>
										<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_XML_IMPORT_EXISTING_CLUB_NEW_TEAM'); ?>
									</input><br>
									<!--
									...
									?>
									>
										<?php echo JText::_('COM_JOOMLEAGUE_ADMIN_XML_IMPORT_NEW_CLUB_NEW_TEAM'); ?>
									</input><br>
								</td>
								<?php
									...
									<td width='45%' style='text-align:left; background-color:<?php echo $color; ?>' id='prtd<?php echo $key; ?>'>
										...
										<table cellspacing='0' cellpadding='0'>
											<tr>
                                                ...
                                                <td><?php echo '<b>'.JText::_('COM_JOOMLEAGUE_ADMIN_XML_IMPORT_KNVBNR').'</b>'; ?><br />
