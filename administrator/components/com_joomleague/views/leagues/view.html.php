...
class JoomleagueViewLeagues extends JLGView
{
	...
	*/
	protected function addToolbar()
	{
		...
		JLToolBarHelper::custom('league.import','upload','upload',JText::_('COM_JOOMLEAGUE_GLOBAL_CSV_IMPORT'),false);
		JLToolBarHelper::archiveList('league.export',JText::_('COM_JOOMLEAGUE_GLOBAL_XML_EXPORT'));
