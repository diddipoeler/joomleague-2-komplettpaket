...
//-->
		...
		<!-- Alt decision table START -->
			<fieldset class="adminform">
				<legend><?php echo JText::_( 'COM_JOOMLEAGUE_ADMIN_MATCH_F_AD' );?>
				</legend>
				<table class='admintable'>
					<tr>
						<td class="key"><?php echo JText::_( 'COM_JOOMLEAGUE_ADMIN_MATCH_F_AD_INCL' );?></td>
						<td><?php echo $this->lists['count_result'];?></td>
					</tr>
					<tr>
						<td class="key"><?php echo JText::_( 'COM_JOOMLEAGUE_ADMIN_MATCH_F_AD_SUB_DEC' );?></td>
						<td colspan="2">
						...
						<td colspan="3">
							<div id="alt_decision_enter" style="display:<?php echo ( $this->match->alt_decision == 0 ) ? 'none' : 'block'; ?>">
								<table class='adminForm' cellpadding='0' cellspacing='7' border='0'>
									<tr>
										<td class="key"><?php echo JText::_( 'COM_JOOMLEAGUE_ADMIN_MATCH_F_AD_NEW_SCORE' ).' ' .$this->match->hometeam; ?></td>
										<td>
									...
									<tr>
										<td class="key"><?php echo JText::_( 'COM_JOOMLEAGUE_ADMIN_MATCH_F_AD_NEW_SCORE' ).' ' .$this->match->awayteam;?></td>
										<td>
									...
									<tr>
										<td class="key"><?php echo JText::_( 'COM_JOOMLEAGUE_ADMIN_MATCH_F_AD_REASON_NEW_SCORE' );?></td>
										<?php
									...
									<tr>
										<td class="key"><?php echo JText::_( 'COM_JOOMLEAGUE_ADMIN_MATCH_F_AD_TEAM_WON' );?></td>
