		...
		<form name="roundForm" id="roundForm" method="post">
			...
			<?php echo JHTML::_('form.token')."\n"; ?>
				...
				if ($lv != "")
				{
					...
					$prevlink=JHTML::link($link,JText::_('COM_JOOMLEAGUE_ADMIN_MATCHES_PREV_MATCH'));
					echo $prevlink;
				}
				else
				{
					echo JText::_('COM_JOOMLEAGUE_ADMIN_MATCHES_PREV_MATCH');
				}
				echo '</div>';
				...
				if (($nv != "") && ($nv != $this->roundws->id))
				{
					...
					$link=JRoute::_('index.php?'.$query);
					$nextlink=JHTML::link($link,JText::_('COM_JOOMLEAGUE_ADMIN_MATCHES_NEXT_MATCH'));
					echo $nextlink;
				}
				else
				{
					echo JText::_('COM_JOOMLEAGUE_ADMIN_MATCHES_NEXT_MATCH');
				}
				echo '</div>';
				?>
				</div>
