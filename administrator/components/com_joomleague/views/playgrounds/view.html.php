...
class JoomleagueViewPlaygrounds extends JLGView
{
	...
	protected function addToolbar()
	{
		...
		JLToolBarHelper::custom('playground.import','upload','upload',JText::_('COM_JOOMLEAGUE_GLOBAL_CSV_IMPORT'),false);
		JLToolBarHelper::archiveList('playground.export',JText::_('COM_JOOMLEAGUE_GLOBAL_XML_EXPORT'));
