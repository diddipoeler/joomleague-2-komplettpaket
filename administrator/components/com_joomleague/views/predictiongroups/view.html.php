...
class JoomleagueViewpredictiongroups extends JLGView
{
	...
	*/
	...
	{ 
		...
		JToolBarHelper::title(JText::_('COM_JOOMLEAGUE_ADMIN_PREDICTIONGROUPS_TITLE'),'predictiongroups');
		
		JLToolBarHelper::addNew('predictiongroup.add');
		JLToolBarHelper::editList('predictiongroup.edit');
		JLToolBarHelper::custom('predictiongroup.import','upload','upload',JText::_('COM_JOOMLEAGUE_GLOBAL_CSV_IMPORT'),false);
		JLToolBarHelper::archiveList('predictiongroup.export',JText::_('COM_JOOMLEAGUE_GLOBAL_XML_EXPORT'));
