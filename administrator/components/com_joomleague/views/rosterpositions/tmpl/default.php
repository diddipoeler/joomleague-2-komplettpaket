...
<form action="<?php echo $this->request_url; ?>" method="post" name="adminForm">
	...
	<div id="editcell">
		<table class="adminlist">
			<thead>
				<tr>
					...
					<th width="85" nowrap="nowrap" style="vertical-align: top; ">
						...
						echo JHTML::_('grid.order',$this->items, 'filesave.png', 'rosterposition.saveorder');
						?>
					</th>
					<th width="20" style="vertical-align: top; ">
			...
			<tbody>
				...
				{
					$row =& $this->items[$i];
					$link=JRoute::_('index.php?option=com_joomleague&task=rosterposition.edit&cid[]='.$row->id);
	...
	<input type="hidden" name="controller" value="rosterposition" />
