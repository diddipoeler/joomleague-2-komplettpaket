 ...
 * @since	0.1
 */
class JoomleagueControllerEditPerson extends JControllerForm
{
...
public function getModel($name = '', $prefix = '', $config = array('ignore_request' => true))
	...
	function load()
	{
		...
		$club = & JTable::getInstance( 'Person', 'Table' );
		$club->load( $cid );
    ...
    //$mainframe->enqueueMessage(JText::_('post -> '.'<pre>'.print_r($post,true).'</pre>' ),'');
        ...
        */
        ...
        $this->setRedirect('index.php?option=com_joomleague&close='.JRequest::getString('close', 0).'&tmpl=component&view=editperson&cid='.$post['id'],$msg,$type);
