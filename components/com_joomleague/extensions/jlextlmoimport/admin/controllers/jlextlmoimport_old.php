 ...
 * @since	1.5.0a
 */
class JoomleagueControllerjlextlmoimport extends JoomleagueCommonController
{
...
*/
		...
		$link='index.php?option=com_joomleague&view=jlextlmoimport&controller=jlextlmoimport&task=edit';
