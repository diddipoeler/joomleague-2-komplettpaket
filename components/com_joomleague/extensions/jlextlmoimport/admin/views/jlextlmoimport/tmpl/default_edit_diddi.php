...
//echo 'teamClub->name ->'.$teamClub->name.' row1->name -> '.$row1->name.'<br>';
              ...
              /*  		
							echo 'foundMatchingTeam <br>';
							echo '<pre>';
							print_r($foundMatchingTeam);
							echo '</pre>';
							*/
                    if ($foundMatchingTeam){$color='lightgreen';}
                      ...
                      if ($foundMatchingTeam)
											...
											echo JText::sprintf('JL_ADMIN_LMO_IMPORT_USE_TEAM',$output);
...
//											  $output="<input type='text' name='dbAssignedTeamId_$key' size='11' maxlength='11' value=\""."\" style='font-weight: bold;' disabled='' />";
//											  echo JText::sprintf('JL_ADMIN_LMO_IMPORT_ASSIGN_TEAM_ID',$output);												
//												echo '<br />';
                      $disabled='';
                      ?>
                      <input type='text' name='dbAssignedTeamId_<?php echo $key; ?>' size='11' maxlength='11' value="0" <?php echo $disabled; ?> />
											<br />
                      <?PHP	
											}
											else
											...
											<table cellspacing='0' cellpadding='0'>
												...
												<tr>
													<td>
														...
														echo '<b>'.JText::_('JL_ADMIN_LMO_IMPORT_TEAMINFO').'</b>';
													...
													<td>
														<?php
														echo '<b>'.JText::_('JL_ADMIN_LMO_IMPORT_TEAMMIDDLE').'</b>';
									...
									if (!empty($clubs))
									{
										...
										<td width='45%' style='text-align:left; vertical-align:top; background-color:<?php echo $color; ?>' id='cltd<?php echo $key; ?>'>
											...
											echo JText::sprintf('JL_ADMIN_LMO_IMPORT_USE_CLUB',$output);
...
//     echo '</pre>';
				...
				<fieldset>
					...
					<table class='adminlist'>
						<thead>
							<tr>
								<th width='5%' nowrap='nowrap'><?php
									echo JText::_('JL_ADMIN_LMO_IMPORT_ALL_NEW');
									echo '<br />';
      ...
      if (isset($positions) && (is_array($positions) && count($positions) > 0))
			...
			echo 'default_edit positions<pre>';
      print_r($positions);
      echo '</pre>';
      ...
      if (isset($persons) && (is_array($persons) && count($persons) > 0))
			{
				?>
				<fieldset>
					<legend><strong><?php echo JText::_('JL_ADMIN_LMO_IMPORT_PERSON_LEGEND'); ?></strong></legend>
					<table class='adminlist'>
						<thead>
							<tr>
								<th width='5%' nowrap='nowrap'><?php
								...
								?></th>
								<th><?php echo JText::_('JL_ADMIN_LMO_IMPORT_PERSON_DATA'); ?></th>
							</tr>
						</thead>
						<tbody>
							<?php
							...
							foreach ($persons AS $key=> $person)
							{
								...
								<tr>
									...
									<td width='45%' style='text-align:left; background-color:<?php echo $color; ?>' id='prtd<?php echo $key; ?>'>
										...
										echo JText::sprintf('JL_ADMIN_LMO_IMPORT_USE_PERSON',$output1,$output2,$output3,$output4);
										...
										if (count($this->persons) > 0)
										{
											...
											echo ")' ";
											echo "/>&nbsp;";
											echo JText::_('JL_ADMIN_LMO_IMPORT_ASSIGN_PERSON');
											echo '<br />';
										}
										else
										{
										...
										echo "/>&nbsp;";
										echo JText::_('JL_ADMIN_LMO_IMPORT_CREATE_PERSON');
										?>
										<br />
										<table cellspacing='0' cellpadding='0'>
											<tr>
												<td><?php echo '<b>'.JText::_('JL_ADMIN_LMO_IMPORT_LNAME').'</b>'; ?><br />
												...
												<td><?php echo '<b>'.JText::_('JL_ADMIN_LMO_IMPORT_FNAME').'</b>'; ?><br />
												...
												<td><?php echo '<b>'.JText::_('JL_ADMIN_LMO_IMPORT_NNAME').'</b>'; ?><br />
												...
												<td><?php echo '<b>'.JText::_('JL_ADMIN_LMO_IMPORT_BIRTHDAY').'</b>'; ?><br />
