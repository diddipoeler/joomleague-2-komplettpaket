 ...
 * @since		1.0
 */
class modJLGStatistikRekordHelper
{
...
$temp  = new stdClass();
$temp->image  = 'modules/mod_diddipoeler_count_rekord/images/matches.png';
//$temp->text  = JText::_( 'SHOW MATCHES DIFF' );

$temp->anzahl  = $anzahl;
$temp->anzahlbis  = $params->get('joomleague_stat_paarungen');
$temp->anzahldiff  = $params->get('joomleague_stat_paarungen') - $anzahl;
