...
foreach ($modelpg->_predictionProjectS AS $predictionProject)
{
		...
		*/
		...
		<form name='resultsRoundSelector' method='post' >
            ...
            $imgTitle=JText::_('JL_PRED_HEAD_RANKING_IMAGE_TITLE');
						$desc = JHTML::image('media/com_joomleague/jl_images/prediction_ranking.png',$imgTitle,array('border' => 0,'title' => $imgTitle));
						echo JHTML::link($link,$desc,array('target' => ''));
		        }
    ...
    <?php
        ...
        {
        echo 'mod_joomleague_top_tipper - predictionMember<br /><pre>~' . print_r($predictionMember,true) . '~</pre><br />';
        }
