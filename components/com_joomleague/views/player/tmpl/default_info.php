	...
	?>
		...
		<table class="plinfo">
			...
			<tr>
				...
				switch ( $this->config['show_birthday'] )
				{
					case 1:	 // show Birthday and Age
						...
						JHTML::date( $this->person->birthday, JText::_('COM_JOOMLEAGUE_GLOBAL_DAYDATE')) : "-";
			...
			<tr>
				...
				<td class="data">
					<?php 
					$deathdateStr =	JHTML::date( $this->person->deathday, JText::_('COM_JOOMLEAGUE_GLOBAL_DEATHDATE')) ;
