...
<table width="96%" align="center" border="0" cellpadding="0" cellspacing="0" class="venueinfo">
	<tr class="sectiontableheader">
		<th colspan="2">
			<?php
			echo JText::_( 'COM_JOOMLEAGUE_PLAYGROUND_DATA' );
			?>
		</th>
	</tr>
	...
	<tr>
		<th class="td_r" width="30%">
				...
				<?php
				echo JText::_( 'COM_JOOMLEAGUE_PLAYGROUND_SHORT' );
				?>
	...
	if ( $this->playground->website )
	{
		...
		<tr>
			<th class="td_r" width="30%">
			   <?php echo JText::_( 'COM_JOOMLEAGUE_PLAYGROUND_WEBSITE' ); ?>
			</th>
			<td>
				<?php
	...
	if ( $this->playground->max_visitors )
	{
		...
		<tr>
			<th class="td_r" width="30%">
					...
					<?php
					echo JText::_( 'COM_JOOMLEAGUE_PLAYGROUND_MAX_VISITORS' );
					?>
