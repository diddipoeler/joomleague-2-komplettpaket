...
$gameModeStr = ($this->model->predictionProject->mode==0) ? JText::_('COM_JOOMLEAGUE_PRED_RESULTS_STANDARD_MODE') : JText::_('JL_PRED_RESULTS_TOTO_MODE');
?><p style='font-weight: bold; '><?php echo JText::_('COM_JOOMLEAGUE_PRED_NOTICE'); ?></p><p><ul><li><i><?php
						echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_NOTICE_INFO_01');
						if (!$this->config['show_all_user'])
						{
							?></i></li><li><i><?php
							echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_NOTICE_INFO_02');
							?></i></li><li><i><?php
						}
						else
						{
						...
						echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_NOTICE_INFO_03');
						?></i></li><li><i><?php
						echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_NOTICE_INFO_04');
						?></i></li><li><i><?php
						echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_NOTICE_INFO_05');
						?></i></li><li><i><?php
						echo JText::sprintf('COM_JOOMLEAGUE_PRED_RESULTS_NOTICE_INFO_06','<b>'.$gameModeStr.'</b>');
						?><?php
						if (($this->config['show_scoring']) && ($this->predictionMember->pmID > 0))
						{
							?></i></li><li><i><?php echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_NOTICE_INFO_07');
							?><table class='blog' cellpadding='0' cellspacing='0'>
								<tr>
									<td class='sectiontableheader' style='text-align:center; '><?php echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_RESULT'); ?></td>
									<td class='sectiontableheader' style='text-align:center; '><?php echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_YOUR_PREDICTION'); ?></td>
									<td class='sectiontableheader' style='text-align:center; '><?php echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_POINTS'); ?></td>
									<?php
									if (($this->model->predictionProject->joker) && ($this->model->predictionProject->mode==0))
									{
										?><td class='sectiontableheader' style='text-align:center; '><?php echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_JOKER_POINTS'); ?></td><?php
									}
									?>
								</tr>
						...
						{
							?></i></li><li><i><?php
							echo JText::_('COM_JOOMLEAGUE_PRED_RESULTS_READ_RULES');
						}
						?></i></li></ul></p>