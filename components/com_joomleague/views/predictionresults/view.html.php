...
class JoomleagueViewPredictionResults extends JLGView
{
    ...
    $this->assignRef( 'optiontext',			$optiontext );
      ...
      $predictionRounds[] = JHTML::_('select.option','0',JText::_('COM_JOOMLEAGUE_JL_PRED_SELECT_ROUNDS'),'value','text');
      if ( $res = &$model->getRoundNames($this->predictionGame->id) ){$predictionRounds = array_merge($predictionRounds,$res);}
			...
			// Set page title
			$pageTitle = JText::_('COM_JOOMLEAGUE_JL_PRED_RESULTS_TITLE');
