		...
		<tr>
			...
			<td colspan='2'>
				<img	class='imagepreview' src='<?PHP echo $this->predictionMember->picture  ; ?>' name='picture_preview'
						id='picture_preview' border='3' alt='<?php echo JText::_('COM_JOOMLEAGUE_PRED_USERS_EDIT_AVATAR_PREVIEW'); ?>' title='<?php echo JText::_('COM_JOOMLEAGUE_PRED_USERS_EDIT_AVATAR_PREVIEW'); ?>' /><br /><?php echo $this->imageselect; ?>
