...
//echo '<br /><pre>~' . print_r($predictionProject,true) . '~</pre><br />';
		...
		<tr>
			<?php
			echo JoomleagueModelPredictionUsers::echoLabelTD('COM_JOOMLEAGUE_JL_PRED_USERS_EDIT_LABEL_AVATAR','COM_JOOMLEAGUE_JL_PRED_USERS_EDIT_LABEL_HELP_AVATAR');
			?>
			<td colspan='2'>
				<img	class='imagepreview' src='<?PHP echo $this->predictionMember->picture  ; ?>' name='picture_preview'
						id='picture_preview' border='3' alt='<?php echo JText::_('COM_JOOMLEAGUE_JL_PRED_USERS_EDIT_AVATAR_PREVIEW'); ?>' title='<?php echo JText::_('COM_JOOMLEAGUE_JL_PRED_USERS_EDIT_AVATAR_PREVIEW'); ?>' /><br /><?php echo $this->imageselect; ?>
